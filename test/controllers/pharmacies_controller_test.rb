...
class PharmaciesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pharmacy" do
    assert_difference('Pharmacy.count') do
      post pharmacies_url, params: { pharmacy: { company_name: @pharmacy.company_name, email: @pharmacy.email, phone: @pharmacy.phone, user_name: @pharmacy.user_name } }
    end
  ...
  test "should update pharmacy" do
    patch pharmacy_url(@pharmacy), params: { pharmacy: { company_name: @pharmacy.company_name, email: @pharmacy.email, phone: @pharmacy.phone, user_name: @pharmacy.user_name } }
